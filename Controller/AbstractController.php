...
abstract class AbstractController extends \Magento\Framework\App\Action\Action
{
    ...
    public function dispatch(RequestInterface $request)
    {
        ...
        $b2b_actions = ['b2b_dashboard_index','b2b_order_products','b2b_order_reorder','b2b_cart_process','b2b_cart_refresh'];
        if(in_array($fullAction, $b2b_actions)
        || ($moduleName == 'b2b' && $controller == 'cart'))
            $this->_coreRegistry->register('b2b', true);
